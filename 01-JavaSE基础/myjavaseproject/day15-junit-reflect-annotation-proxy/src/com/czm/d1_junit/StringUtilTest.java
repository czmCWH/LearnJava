...
/**
 * 测试类，使用 junit 单元测试框架，对业务类中的业务方法进行正确性测试！
 */
public class StringUtilTest {
    ...
    /**
     * 测试方法1
     * 使用 @Test 注解标识测试方法，测试方法必须是 public、无参、无返回值
     * @Test 注解是使用 junit 框架的核心步骤
     */
    @Test
    public void testPrintNumber() {
        // 书写测试：
        // 根据测试用例，使用业务类调用其方法，验证其执行正确性
...
//        System.out.println(StringUtil.getMaxIndex("abc"));
        ...
        // 如上虽然方法都能测试通过，但是业务结果不是我们期望的，就需要用 Assert 断言，来实现正确的测试用例
        // Assert 断言测试：预言，断言测试结果是否与预期结果一致
